...
\caption{\label{fig:corr_docentes}Correlação das respostas dos alunos do curso CCOGV para as questões apresentadas. Entradas com em branco indicam que não havia dados suficientes para o cálculo das correlações.}
\end{figure}
