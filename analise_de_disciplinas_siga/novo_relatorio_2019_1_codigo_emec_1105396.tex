...
\begin{figure}[h]
\centering
\includegraphics[width=0.999\linewidth]{resposta_questoes_curso_1105396.png}
\caption{\label{fig:resposta_questoes_curso}Distribuição das respostas dos discentes para as questões apresentadas}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.999\linewidth]{matriz_corr__1105396.png}
\caption{\label{fig:corr_alunos}Correlação das respostas dos discentes do curso ADMINISTRAÇÃO PÚBLICA (EAD) para as questões apresentadas}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{ingresso_discentes_curso_ano_1105396.png}
\caption{\label{fig:ingresso_ano} Perfil do ano de ingresso dos alunos respondentes em função de ingresso.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{ingresso_discentes_curso_tipo_1105396.png}
\caption{\label{fig:tipo_ingresso_ano}  Perfil  do tipo de ingresso dos alunos respondentes  em função do ano de ingresso.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{quantitativos_estado_de_origem_1105396.png}
\caption{\label{fig:estado_ano} Perfil do estado de origem dos alunos respondentes em função do ano de ingresso.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{quantitativos_bolsa_de_apoio_1105396.png}
