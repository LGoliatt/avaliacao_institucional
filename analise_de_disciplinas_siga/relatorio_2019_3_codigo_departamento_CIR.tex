...
\title{RELATÓRIO DE RESULTADOS DA AVALIAÇÃO DE DEPARTAMENTO\\ Código do Departamento: CIR}
\maketitle
\section{INTRODUÇÃO}
Este relatório objetiva apresentar os resultados da avaliação de disciplinas do Departamento     de código CIR da Universidade Federal de Juiz de Fora, realizada pela     Diretoria de Avaliação Institucional e os encaminhamentos propostos a     partir destes resultados.

\begin{center}
\begin{tabularx}{\linewidth}{X|l}

Público-alvo:& Departamento  CIR\\

Período de coleta de dados:& 2019/3.\\

Forma de aplicação:& Online, por meio do SIGA.\\

Docentes respondentes:& 2\\
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{analise_geral_departamento_CIR_docentes.png}
\includegraphics[width=0.85\linewidth]{analise_geral_departamento_CIR_alunos.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.999\linewidth]{matriz_corr__CIR_docentes.png}
\caption{\label{fig:corr_docentes}Correlação das respostas dos professores do departamento CIR. Entradas com em branco indicam que não havia informação suficiente para o cálculo das correlações.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.999\linewidth]{matriz_corr__CIR_alunos.png}
\caption{\label{fig:corr_alunos}Correlação das respostas dos alunos para o departamento CIR. Entradas com em branco indicam que não havia informação suficiente para o cálculo das correlações.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.485\linewidth]{analise_disciplina_departamento_CIR_EE1447ED6B44CD3896762506592A4474_docentes.png}
\includegraphics[width=0.485\linewidth]{analise_disciplina_departamento_CIR_EE1447ED6B44CD3896762506592A4474_alunos.png}
\caption{\label{fig:analise_geral_departamento}                Distribuição das respostas para a disciplina EE1447ED6B44CD3896762506592A4474. }
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.485\linewidth]{analise_disciplina_departamento_CIR_726F22BA54631E6ADF10B4B482F21C5D_docentes.png}
\includegraphics[width=0.485\linewidth]{analise_disciplina_departamento_CIR_726F22BA54631E6ADF10B4B482F21C5D_alunos.png}
\caption{\label{fig:analise_geral_departamento}                Distribuição das respostas para a disciplina 726F22BA54631E6ADF10B4B482F21C5D. }
\end{figure}
