...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{analise_geral_departamento_QUI_docentes.png}
\includegraphics[width=0.85\linewidth]{analise_geral_departamento_QUI_alunos.png}
